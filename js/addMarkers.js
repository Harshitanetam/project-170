    ...
    dishes.map(dish => {
     ...
     dishtitle.setAttribute('id',`dish-title-${dish.id}`)
      ...
      dishtitle.setAttribute('text',{
       font: "monoid", color: "black", width: 1.8, height: 1, align: "center", value: dish.dish_name.toUpperCase()

      })
      titlePlane.appendChild(dishtitle)

      // Ingredients List
      var ingredients = document.createElement("a-plane");
     ingredients.setAttribute('id',`ingredients-${dish.id}`)
      ingredients.setAttribute('position',{x:0.3,y:0,z:0.1})
      ingredients.setAttribute('rotation',{x:0,y:0,z:0})     
     ingredients.setAttribute('text',{
       font: "monoid", color: "black", width: 1.8,align: "left", value:`${this.ingredients.join('\n\n')}`
